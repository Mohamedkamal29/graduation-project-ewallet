...
public class Constant {
    ...
    public static class Service{
     ...
     public final static String  ADS_ID="ads_id";
     ...
     public final static String WHATS_UP ="whats_up";
     ...
     public final static String nat_id="nat_id";
    ...
    public static class SharedPrefKey {
     ...
     public final static String NOTIFCATION_COUNTER ="notification_counter";
